...
namespace Marketplace.Presentation
{
    public static class GetUserInput
    {
        ...
        public static string GetEmail(Marketplace.Data.Program.Context marketplace)
        {
            ...
            while (askForMail)
            {
                ...
                var valid = Domain.Validation.Validation.ValidateEmail(mail);
                var notTaken = Domain.Validation.Validation.IsEmailAvailable(mail, marketplace);
        ...
        public static string GetUsername(Data.Program.Context marketplace)
        {
            ...
            while (askForUsername)
            {
                ...
                var valid = Domain.Validation.Validation.ValidateUsername(username);
                var notTaken = Domain.Validation.Validation.IsUsernameAvailable(username, marketplace);
        ...
        public static string GetExistingEmail(Data.Program.Context marketplace)
        {
            var mail = string.Empty;
            var askForMail = true;
        ...
        public static string GetExistingUsername(Data.Program.Context marketplace)
        {
            var username = string.Empty;
            var askForUsername = true;
        ...
        public static Seller RegisterSeller(Data.Program.Context marketplace)
        {
            Console.Clear();
            Console.WriteLine("\n REGISTER AS SELLER\n\n");
        ...
        public static Customer RegisterCustomer(Data.Program.Context marketplace)
        {
            Console.Clear();
        ...
        public static User LogInUser(Data.Program.Context marketplace)
        {
            Console.Clear();
            Console.WriteLine("\n LOG IN\n\n");
            ...
            return userRepo.GetUser(username, email);
        }
